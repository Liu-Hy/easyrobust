...
def find_classes(directory: str, info_path: str) -> Tuple[List[str], Dict[str, int]]:
...
def make_dataset(
    ...
    if class_to_idx is None:
        _, class_to_idx = find_classes(directory, info_path)
...
class DatasetFolder(VisionDataset):
    ...
    def make_dataset(
        ...
        return make_dataset(directory, info_path, class_to_idx, extensions=extensions, is_valid_file=is_valid_file)

    def find_classes(self, directory: str, info_path: str) -> Tuple[List[str], Dict[str, int]]:
        ...
        """
        return find_classes(directory, info_path)
    ...
    def get_meta(self) -> Dict:
        ...
        meta["class_to_idx"] = self.class_to_idx
